    ...
    <header className="w-full px-6 py-4 bg-white shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center">
                  {/* <span className="text-2xl font-bold">minusx</span> */}
            <img src='https://www.datasaki.com/assets/img/logo.png'/>
        </div>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          {/* GitHub Stars */}
          <a href="#" className="flex items-center space-x-1 bg-gray-100 px-3 py-1 rounded-md">
            ...
            <span>Star</span>
            <span className="bg-white px-2 py-0.5 rounded">195</span>
          </a>
